...
function populateLevelList() {
    // for the 37 pictures found in frontend/public/static/level miniatures, add div in the div called levelList that displays the image of the level anf the number on top.
